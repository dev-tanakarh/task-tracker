package com.devtanaka.tasks.domain.entities;
...
public class TaskList {
    ...
    @OneToMany(mappedBy = "taskList", cascade = {
            CascadeType.REMOVE,  //When we delete a tasklist then all tasks are deleted
            CascadeType.PERSIST //When we save a taskList then all tasks in that list are saved
    })
    List<Task> tasks;
